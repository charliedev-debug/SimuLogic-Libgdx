...
class CNot(x:Float, y:Float, rotationDirection:Int, private val scene: PlayGroundScene) :CNode(){
    ...
    override fun clone():CNode {
        return CNot(getPosition().x,getPosition().y, rotationDirection, scene )
    }
