...
class CNor(x:Float, y:Float, rotationDirection:Int, private val scene: PlayGroundScene) :CNode(){
    ...
    override fun clone():CNode {
        return CNor(getPosition().x,getPosition().y,rotationDirection, scene )
    }
