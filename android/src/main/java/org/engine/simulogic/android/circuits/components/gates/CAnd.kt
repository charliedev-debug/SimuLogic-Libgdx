...
class CAnd(x:Float, y:Float, private val scene: PlayGroundScene) :CNode(){
    ...
    init {
        ...
        signals.add(CSignal(x - sprite.width * 0.8125f, y + sprite.height / 2f - sprite.height * 0.1875f ,CTypes.SIGNAL_IN, 1, scene))
