...
class CustomDataBusDialog  (context: Context, private val listener:OnEditProjectClickListener) : Dialog(context) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val view = layoutInflater.inflate(R.layout.custom_data_bus_dialog_layout,null)
