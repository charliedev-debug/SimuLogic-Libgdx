        ...
        val helpAdapter = HelpAdapter().apply {
            ...
            add(
                HelpItem(
                    ...
                    layoutId = R.layout.help_item_view,
                    layoutIcon = R.drawable.ungroup
                )
            )
            add(
                HelpItem(
                    "Undo",
                    description = "Undo/removes the current operation in order.",
                    layoutId = R.layout.help_item_view,
            ...
            add(
                HelpItem(
                    "Redo",
                    description = "Redo/restores the previous operation in order.",
                    layoutId = R.layout.help_item_view,
                    layoutIcon = R.drawable.redo
                )
            )
            add(
                HelpItem(
            ...
            add(
                HelpItem(
                    "POWER ON",
                    description = "Toggles a signal to HIGH(1). Can also be toggled to OFF in interaction mode.",
                    layoutId = R.layout.help_item_view,
                    layoutIcon = R.drawable.power_on
                )
            )
            add(
                HelpItem(
                    "POWER OFF",
                    description = "Toggles a signal to HIGH(1). Can also be toggled to ON in interaction mode.",
                    layoutId = R.layout.help_item_view,
