...
class CAndThreeInput(x:Float, y:Float,rotationDirection:Int = ROTATE_RIGHT, private val scene: PlayGroundScene) :CNode(){
    ...
    override fun clone():CNode {
        return CAndThreeInput(getPosition().x,getPosition().y,rotationDirection, scene )
    }
