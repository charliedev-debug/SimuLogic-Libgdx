...
class CXor(x:Float, y:Float,rotationDirection:Int, private val scene: PlayGroundScene) :CNode(){
    ...
    init {
        ...
        val spriteRegion = textureAtlas.findRegion("XOR-DARK")
        type = CTypes.XOR
    ...
    override fun execute() {
        ...
        output.value = inputA.value.xor(inputB.value)
    }
    ...
    override fun clone():CNode {
        return CXor(getPosition().x,getPosition().y,rotationDirection, scene )
    }
