    ...
    override fun create() {
        ...
        when(simulationOptions.theme){
            "rosepine"->{
                ...
                EnvironmentTheme.colorOutline2 = Color(37f/255f, 35f/255f, 47f/255f, 1f)
            ...
            "gruvbox"->{
                ...
                EnvironmentTheme.colorOutline2 = Color( 42f/255f, 38f/255f, 36f/255f, 1f)
            ...
            "tokyonight"->{
                ...
                EnvironmentTheme.colorOutline = Color(80f/255f, 73f/255f, 69f/255f, 1f)
                EnvironmentTheme.colorOutline2 = Color( 40f/255f, 36f/255f, 34f/255f, 1f)
            ...
            "kanagawa"->{
                ...
                EnvironmentTheme.colorOutline2 = Color(58f/255f, 58f/255f, 75f/255f, 1f)
            ...
            "catppuccin"->{
                ...
                EnvironmentTheme.colorOutline2 = Color(44f/255f, 46f/255f, 66f/255f, 1f)
