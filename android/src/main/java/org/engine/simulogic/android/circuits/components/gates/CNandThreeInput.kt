...
class CNandThreeInput(x:Float, y:Float,rotationDirection:Int = ROTATE_RIGHT, private val scene: PlayGroundScene) :CNode(){
    ...
    override fun clone():CNode {
        return CNandThreeInput(getPosition().x,getPosition().y,rotationDirection, scene )
    }
