...
class COr(x:Float, y:Float, rotationDirection:Int, private val scene: PlayGroundScene) :CNode(){
    ...
    override fun execute() {
        ...
        output.value = inputA.value.or(inputB.value)
    }
    ...
    override fun clone():CNode {
        return COr(getPosition().x,getPosition().y, rotationDirection, scene )
    }
