...
class COrThreeInput(x:Float, y:Float,rotationDirection:Int = ROTATE_RIGHT, private val scene: PlayGroundScene) :CNode(){
    ...
    init {
        ...
        val spriteRegion = textureAtlas.findRegion("OR-DARK")
        type = CTypes.OR_THREE_INPUT
    ...
    override fun clone():CNode {
        return COrThreeInput(getPosition().x,getPosition().y,rotationDirection, scene )
    }
