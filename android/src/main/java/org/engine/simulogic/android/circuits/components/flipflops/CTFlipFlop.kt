...
class CTFlipFlop(x:Float, y:Float, rotationDirection:Int, private val scene: PlayGroundScene) :CNode(){
    ...
    init {
        ...
        val spriteRegion = textureAtlas.findRegion("T-FLIP-FLOP")
        type = CTypes.T_FLIP_FLOP
